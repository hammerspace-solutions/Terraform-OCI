#!/bin/bash
#
# Ansible Job: Add Storage Server Volumes
#
# This script adds non-reserved logical volumes from STORAGE SERVER nodes only (not ECGroup).
# It is idempotent and only adds new volumes when add_storage_server_volumes=true.
